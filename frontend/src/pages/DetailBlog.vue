...
<template>
    <DefaultLayout>
        ...
        <h1 class="text-5xl md:text-6xl lg:text-[75px] font-bold uppercase mb-4">Details Blog</h1>
        <p class="text-xl md:text-2xl font-light mb-8">
            Lightweight article where discussing matters relating to the book
        </p>
        </div>

        <div v-if="blog" class="w-full px-6 pb-10 pt-10 bg-[#F5F6F8] flex flex-col items-center">
            <div>
                <img :src="blog.imgBlogDetail" class="h-[400px]" alt="Image Blog">
